...
<div class="space-y-2 rounded hover:scale-105">
  <div class="inline-flex items-center px-1 space-x-1 text-xs text-orange-400 border rounded-sm">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" height="11px" width="11px">
  ...
  <div class="flex items-start">
    ...
    <span class="text-sm pt-0.5 pl-0.5">€</span>
  </div>
